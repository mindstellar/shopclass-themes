...
> [!IMPORTANT]
> **Not yet accepting submissions.** This repository is scaffolding: schemas, docs, and the
> two registrations below exist, but PR validation (the automated checks a submission would
> need to pass) is not built yet. A theme submitted today cannot be checked by CI and will
> not be merged. Watch this repository or the core project's release notes for when
> submissions open.
...
| PR validation (structure, manifest, header, compatibility, security scan, smoke install) | Not built |
